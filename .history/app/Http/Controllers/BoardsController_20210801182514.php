...
class BoardsController extends Controller
{
    ...
    {
        return new BoardResource(Board::where('user_id', '=', $u_id)->where('id', '=', $b_id)->first());
    }
    public function upBoard($b_id, $u_id)
    {
        $board = Board::where('user_id', '=', $u_id)->where('id', '=', $b_id)->first();
    }
