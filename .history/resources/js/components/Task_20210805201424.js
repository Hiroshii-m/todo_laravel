...
export default class Task extends React.Component {
    ...
    handleChangeExpTime(e) {
        // this.setState({
        //     expHour: (e.target.value).slice(0, 2),
        //     expMin: (e.target.value).slice(-2)
        // });
    }
    ...
    render() {
        ...
        // それぞれ「分」のデータを「時間：分」に直す
        let expHour = this.getDoubleDigitNum(Math.floor(this.state.expTime/60));
        let expMin = this.getDoubleDigitNum(this.state.expTime - (expHour * 60));
        let speHour = this.getDoubleDigitNum(Math.floor(this.state.speTime/60));
        let speMin = this.getDoubleDigitNum(this.state.expTime - (speHour * 60));
                        ...
                        <div className="c-acd__content p-todoList__acd">
                            ...
                            <div className="c-acd__time">
                                ...
                                <div className="p-todoList__time u-flex">
                                    <input className="p-todoList__timeInput" min="0" type="number" defaultValue={this.state.expTime} />:<input className="p-todoList__timeInput" type="number" min="0" max="59" defaultValue="0" />
                                </div>
                                </p>
                                <p>作業時間：
                                <div className="p-todoList__time u-flex">
                                    <input className="p-todoList__timeInput" min="0" type="number" defaultValue={"0"} />:<input className="p-todoList__timeInput" type="number" min="0" max="59" defaultValue="0" />
                                </div>
                                </p>
