...
export default class TaskList extends React.Component {
    ...
    callBackChangeExpTime(num) {
        this.props.onChangeExpTime(num);
    }
    render() {
        let head = '';
        let bottom = '';
        let todos = [];
        const newTask = <Task id={'n'} c_id={this.props.id} text={''} taskMode={'New'} onAddTodo={this.callBackAddTodo}　onUpTodo={this.callBackUpTodo} onRemoveTodo={this.callBackRemoveTodo} onToggleDone={this.callBackToggleDone} onChangeExpTime={this.callBackChangeExpTime} />;
