...
export default class TaskList extends React.Component {
    constructor(props) {
        ...
        this.callBackChangeExpTime = this.callBackChangeExpTime.bind(this);
        this.callBackChangeExpMinute = this.callBackChangeExpMinute.bind(this);
        this.callBackChangeSpeTime = this.callBackChangeSpeTime.bind(this);
        this.callBackChangeSpeMinute = this.callBackChangeSpeMinute.bind(this);
    }
    ...
    callBackChangeExpTime(todoData) {
        this.props.onChangeExpTime(todoData);
    }
    callBackChangeExpMinute(todoData) {
        this.props.onChangeExpMinute(todoData);
    }
    callBackChangeSpeTime(todoData) {
        this.props.onChangeSpeTime(todoData);
    }
    callBackChangeSpeMinute(todoData) {
    ...
    render() {
        ...
        let bottom = '';
        let todos = [];
        const newTask = <Task id={'n'} c_id={this.props.id} text={''} taskMode={'New'} onAddTodo={this.callBackAddTodo}　onUpTodo={this.callBackUpTodo} onRemoveTodo={this.callBackRemoveTodo} onToggleDone={this.callBackToggleDone} onChangeExpTime={this.callBackChangeExpTime} onChangeExpMinute={this.callBackChangeExpMinute} onChangeSpeTime={this.callBackChangeSpeTime} onChangeSpeMinute={this.callBackChangeSpeMinute} />;
        ...
        for(let i in this.props.todos) {
            todos.push(<Task    key={this.props.todos[i].id}
                                ...
                                onChangeExpTime={this.callBackChangeExpTime}
                                onChangeExpMinute={this.callBackChangeExpMinute}
                                onChangeSpeTime={this.callBackChangeSpeTime}
                                onChangeSpeMinute={this.callBackChangeSpeMinute} />);
        }
        return (
