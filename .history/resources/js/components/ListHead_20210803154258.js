...
export default class ListHead extends React.Component {
    ...
    render() {
        ...
        <div className="u-flex c-component__item"><input onChange={this.handleChange} type="text" value={this.state.text} /><button onClick={this.handleCloseEdit} className="p-todoList__btn"><i className="fas fa-arrow-circle-up"></i></button></div>:
