...
export default class TaskList extends React.Component {
    ...
    render() {
        ...
        switch(this.state.ListMode) {
            case 'New':
                head = <span onClick={this.handleInput} className="p-todoList__add u-bgColor--primary"><i className="fas fa-plus"></i>リストを追加</span>;
                bottom = '';
                break;
            case 'Input':
                head = 
                ...
                <div className="p-todoList__bottom">
                    <button onClick={this.addList} className="p-todoList__btn c-component__item u-margin-right--xl u-padding--s-m u-bgColor--primary">リスト追加</button>
            ...
            case 'Show':
                ...
                bottom = <div className="p-todoList__bottom"><button onClick={this.addList} className="p-todoList__btn c-component__item u-margin-right--xl u-padding--s-m u-bgColor--error">リストを削除</button></div>;
                break;
            case 'Edit':
                head = 
                <div className="p-todoList__head">
