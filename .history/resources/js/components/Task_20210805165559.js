                    ...
                    <div className="c-acd">
                        ...
                        <div className="c-acd__content p-todoList__acd">
                            ...
                            <div className="c-acd__time">
                                <p>予想時間：<input type="number" value={this.state.expTime} /><input type="number" value={this.state.expTime} /></p>
                                <p>作業時間：<input type="number" defaultValue={this.state.speTime} onChange={this.handleChangeSpeTime} /></p>
