            ...
            <div id="l-modal" className={classNameShow}>
                <div className="p-boardModal show">
                    ...
                    <form className="p-boardModal__form" method="post" onSubmit={this.handleSubmit}>
                        ...
                        <div className="">
                            <input name="board_name" className="p-boardModal__input" type="text" value={this.state.val} onChange={this.handleChange} placeholder="ボード名" />
                        </div>
                        <div className="p-boardModal__bottom">
                            <p className="p-form__error">{errMsg}</p>
