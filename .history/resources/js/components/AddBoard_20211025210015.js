        ...
        return (
            <div id="l-modal" className={classNameShow}>
                <div className="p-modal show">
                    ...
                    <form className="p-modal__form" method="post" onSubmit={this.handleSubmit}>
                        <input type="hidden" name="_token" value={csrf_token} />
                        <div className="">
                            <input name="board_name" className="p-modal__input" type="text" value={this.state.val} onChange={this.handleChange} placeholder="ボード名" />
                        </div>
                        <div className="p-modal__bottom">
                            <p className="c-form__error">{errMsg}</p>
                            <button className="p-modal__submit">作成</button>
                        </div>
                    </form>
                </div>
            </div>
