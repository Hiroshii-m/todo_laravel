...
export default class Task extends React.Component {
    ...
    componentDidMount() {
        if(!Number.isInteger(this.props.expTime)) {
            this.props.expTime = 0;
        }
        if(!Number.isInteger(this.props.expMinute)) {
            this.props.expMinute = 0;
        }
        if(!Number.isInteger(this.props.speTime)) {
            this.props.speTime = 0;
        }
        if(!Number.isInteger(this.props.speMinute)) {
            this.props.speMinute = 0;
        }
    }
    handleNew() {
        this.setState({
