...
export default class Task extends React.Component {
    ...
    handleUpTime() {
        const todoData = {
            id: this.state.id, expTime: parseInt(this.state.expTime), expMinute: parseInt(this.state.expMinute), 
            speTime: parseInt(this.state.speTime), speMinute: parseInt(this.state.speMinute)
        };
    ...
    render() {
        ...
        const icon = <i onClick={this.handleToggleDone} className={classNameIcon}></i>;
        const timer = (this.state.isTimer) ? 
        <div className="c-timer u-margin-top--l">
        ...
        switch(this.state.taskMode){
            ...
            case "Show":
                ...
                <div className="">
                    ...
                    <div className="p-acd">
                        <input className="p-acd__check" type="checkbox" />
                        <div className="p-acd__content p-todoList__acd">
                            <div onClick={this.handleEdit} className="p-acd__item">
                                <i className="far fa-edit p-todoList__icon"></i>
                                <p className="p-acd__text">編集</p>
                            </div>
                            <div onClick={this.removeTodo} className="p-acd__item">
                                <i className="far fa-trash-alt p-todoList__icon"></i>
                                <p className="p-acd__text">削除</p>
                            </div>
                        ...
                        <i className="fas fa-chevron-down p-todoList__icon p-todoList__acon p-acd__icon p-acd__down"></i>
                        <i className="fas fa-chevron-up p-todoList__icon p-todoList__acon p-acd__icon p-acd__up"></i>
                    </div>
                </div>;
                break;
            case "Edit":
