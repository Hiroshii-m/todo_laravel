    ...
    render() {
        ...
        switch(this.state.listMode) {
            ...
            case 'Show':
                head = 
                <div>
                    <button onClick={this.removeList} className="p-todoList__btn c-component__item u-margin-right--xl u-padding--s-m u-bgColor--error"><i class="fas fa-trash-alt"></i></button>
                    <div className="p-todoList__head">
