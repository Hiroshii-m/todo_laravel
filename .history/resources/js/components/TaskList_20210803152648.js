    ...
    render() {
        ...
        switch(this.state.ListMode) {
            ...
            case 'Show':
                head = 
                <div className="p-todoList__head">
                    <div onClick={this.handleEdit} className="p-todoList__name u-flex u-justify-content--space-between">
            ...
            case 'Edit':
                head = 
                <div className="p-todoList__head">
                    <div className="p-todoList__name u-flex">
                        <input type="text" className="" placeholder="リスト名" />
                        <button className="p-todoList__btn"><i className="fas fa-arrow-circle-up"></i></button>
                    </div>
                    <p>{this.props.word['ExpTime']}：5時間</p>
                    <p>{this.props.word['SpeTime']}：10時間10分</p>
                    <p>{this.props.word['TimeLug']}：+5時間10分</p>
