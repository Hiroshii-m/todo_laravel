                        ...
                        <div className="c-acd__content p-todoList__acd">
                            ...
                            <div className="c-acd__time">
                                ...
                                <div className="u-flex">
                                    <input className="p-todoList__input u-margin--0-m" min="0" type="number" value={this.state.expTime} />:<input className="p-todoList__input u-margin--0-m" type="number" max="59" />
                                </div>
                                </p>
                                <p>作業時間：
