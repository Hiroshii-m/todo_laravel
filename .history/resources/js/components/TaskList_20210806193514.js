...
export default class TaskList extends React.Component {
    ...
    render() {
        ...
        for(let i in this.state.todos) {
            if(this.state.todos[i].cluster_id === this.state.id) {
                expTimeTotal += this.state.todos[i].expect_time;
                expMinuteTotal += this.state.todos[i].expect_minute;
                console.log(this.state.todos[i].expect_time);
            }
        }
