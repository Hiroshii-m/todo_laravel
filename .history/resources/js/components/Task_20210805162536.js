...
export default class Task extends React.Component {
    ...
    handleChangeExpTime(e) {
        const expNextTime = ((e.target.value).slice(0, 2) * 60) + (e.target.value).slice(-2);
        console.log(expNextTime);
        this.setState({
                    ...
                    <div className="c-acd">
                        ...
                        <div className="c-acd__content p-todoList__acd">
                            ...
                            <div className="c-acd__time">
                                <p>予想時間：<input type="time" value={this.state.expHour + ':' + this.state.expMin} onChange={this.handleChangeExpTime} /></p>
                                <p>作業時間：<input type="time" defaultValue={speHour + ':' + speMin} /></p>
