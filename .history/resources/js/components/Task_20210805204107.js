                            ...
                            <div className="c-acd__time">
                                <div className="">予想時間：
                                    <div className="p-todoList__time u-flex">
                                        <input className="p-todoList__timeInput" min="0" type="number" value={this.state.expTime} onChange={this.handleChangeExpTime} />時間<input className="p-todoList__timeInput" type="number" min="0" max="59" value={this.state.expMinute} onChange={this.handleChangeExpMinute} />分
                                    </div>
                                </div>
                                <div>作業時間：
                                    <div className="p-todoList__time u-flex">
