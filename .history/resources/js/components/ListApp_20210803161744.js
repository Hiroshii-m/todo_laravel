...
export default class ListApp extends Component {
    ...
    callBackUpList(text) {
        // テキストをクラスターテーブル（リスト）に変更
    }
    render() {
        return (
            <div>
                <ListHead text={this.state.board_name} onChangeBoard={this.handleChangeBoard} />
                <ListTodo onAddList={this.callBackAddList} clusters={this.state.clusters} todos={this.state.todos} word={this.state.word} onUpList={this.callBackUpList} />
            </div>
        );
    }
}
