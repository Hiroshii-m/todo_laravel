    ...
    render() {
        ...
        switch(this.state.taskMode){
            ...
            case "Input":
                task = 
                <div>
                    <input type="text" className="p-todoList__input c-component__item" placeholder="TODO名" value={this.state.text} onChange={this.handleChange} />
                    <div className="p-todoList__bottom">
                        ...
                        <i onClick={this.handleNew} className="far fa-times-circle p-todoList__icon u-margin-right--m"></i>
                    </div>
                </div>;
                break;
            case "Show":
