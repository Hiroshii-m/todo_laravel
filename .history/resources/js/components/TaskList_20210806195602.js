...
export default class TaskList extends React.Component {
    ...
    render() {
        ...
        // クラスター（リスト）のTODOの予想時間を全て加算する
        let expTimeTotal = 0;
        for(let i in this.props.todos) {
            console.log(this.props.todos[i].expect_time);
            console.log(Number.isNumber(this.props.todos[i].expect_time));
            console.log(typeof this.props.todos[i].expect_time);
            // if(this.props.todos[i].cluster_id === this.props.id) {
            //     expTimeTotal += this.state.props[i].expect_time;
            // }
        }
        ...
        switch(this.state.listMode) {
            ...
            case 'Show':
                ...
                <div className="p-todoList__head">
                    ...
                    <p>{this.props.word['ExpTime']}：{expTimeTotal}時間</p>
