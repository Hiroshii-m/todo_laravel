    ...
    render() {
        ...
        switch(this.state.listMode) {
            ...
            case 'Show':
                ...
                bottom = <div>
                    <Task id={'n'} c_id={this.props.id} text={''} taskMode={'New'} onAddTodo={this.callBackAddTodo} />
            ...
            case 'Edit':
                ...
                bottom = <div>
                <Task id={'n'} c_id={this.props.id} text={''} taskMode={'New'} onAddTodo={this.callBackAddTodo} onUpTodo={this.callBackUpTodo} />
                <div className="u-flex">
                    <button onClick={this.removeList} className="p-todoList__remove u-bgColor--error">
                        削除
                    </button>
