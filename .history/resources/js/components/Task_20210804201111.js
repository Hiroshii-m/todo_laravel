...
export default class Task extends React.Component {
    ...
    render() {
        ...
        switch(this.state.taskMode){
            case "New":
                task = <span onClick={this.handleInput} className="p-todoList__add"><i className="fas fa-plus"></i>&thinsp;TODOを追加</span>;
                break;
            case "Input":
                task = 
                <div>
            ...
            case "Show":
                ...
                <div className="">
                    <div className="p-todoList__todo">
                        ...
                        <span onClick={this.handleEdit} className="p-todoList__text u-margin--0-m">{this.state.text}</span>
                    </div>
                    <div className="c-acd">
            ...
            case "Edit":
                ...
                <div className="">
                    <div className="p-todoList__todo">
                        <i className="far fa-square p-todoList__icon"></i>
                        <input type="text" className="p-todoList__input u-margin--0-m" placeholder="TODO名" value={this.state.text} onChange={this.handleChange} />
                    </div>
                    <div className="c-acd">
                        <input className="c-acd__check" type="checkbox" />
                        <div className="c-acd__content p-todoList__acd">
