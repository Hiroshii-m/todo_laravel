                    ...
                    <div className="c-acd">
                        ...
                        <div className="c-acd__content p-todoList__acd">
                            ...
                            <div className="c-acd__time">
                                ...
                                {timer}
                                <button onClick={this.addTodo} className="p-todoList__submit u-bgColor--accent c-component__item"><i className="fas fa-arrow-circle-up"></i>&emsp;予想・作業時間保存</button>
                            </div>
                        </div>
