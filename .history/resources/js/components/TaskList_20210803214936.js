    ...
    render() {
        ...
        switch(this.state.listMode) {
            ...
            case 'Show':
                head = 
                <div className="p-todoList__head">
                    <div className="p-todoList__name u-justify-content--space-between">
                        <span onClick={this.handleEdit}  className="u-margin--0-m">{this.state.text}</span>
                        <button onClick={this.removeList} className="p-todoList__remove c-component__item u-bgColor--error"><i className="fas fa-times-circle"></i></button>
                    </div>
