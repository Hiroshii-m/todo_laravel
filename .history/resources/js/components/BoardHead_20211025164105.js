    ...
    render() {
        return (
            <div className="p-boardHead__head">
                ...
                <button className="p-boardHead__btn--pc" onClick={this.handleAddBoardShow}>新たにボードを作成</button>
                <button className="p-boardHead__btn--sp" onClick={this.handleAddBoardShow}><i className="fas fa-plus"></i></button>
            </div>
        );
    }
}