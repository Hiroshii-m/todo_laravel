...
export default class ListApp extends Component {
    ...
    callBackChangeExpTime(todoData) {
        this.setState(prevState => ({
            todos: prevState.todos.map(
                obj => (obj.id === todoData['id'] ? Object.assign(obj, {expect_time: todoData['expTime']}): obj)
            )
        }));
    }
    callBackChangeExpMinute(todoData) {
        this.setState(prevState => ({
            todos: prevState.todos.map(
                obj => (obj.id === todoData['id'] ? Object.assign(obj, {expect_minute: todoData['expMinute']}): obj)
            )
        }));
    }
    callBackChangeSpeTime(todoData) {
        this.setState(prevState => ({
            todos: prevState.todos.map(
                obj => (obj.id === todoData['id'] ? Object.assign(obj, {expect_minute: todoData['speTime']}): obj)
            )
        }));
    }
    callBackChangeSpeMinute(todoData) {
        this.setState(prevState => ({
            todos: prevState.todos.map(
                obj => (obj.id === todoData['id'] ? Object.assign(obj, {expect_minute: todoData['speMinute']}): obj)
            )
        }));
    }
    render() {
