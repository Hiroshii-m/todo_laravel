...
export default class Task extends React.Component {
    ...
    addTodo() {
        const todoData = {id: this.state.id, c_id: this.props.cluster_id, text: this.state.addText};
    ...
    render() {
        ...
        switch(this.state.taskMode){
            ...
            case "Input":
                task = 
                <div>
                    <input type="text" className="p-todoList__input" placeholder="TODO名" value={this.state.addText} onChange={this.handleChange} />
