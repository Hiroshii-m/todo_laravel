    ...
    render() {
        ...
        switch(this.state.ListMode) {
            ...
            case 'Show':
                ...
                bottom = <div className="p-todoList__bottom"><button onClick={this.addList} className="p-todoList__btn c-component__item u-margin-right--xl u-padding--s-m u-bgColor--primary">削除</button></div>;
                break;
            case 'Edit':
                head = 
                <div className="p-todoList__head">
