                        ...
                        <div id="l-itemMenu" class="js-target-display">
                            <ul class="p-boardList__modal c-itemMenu">
                                <li class="c-itemMenu__item">
                                    <a class="c-itemMenu__txt"><i class="far fa-folder-open c-itemMenu__icon"></i>{{ __('Open') }}</a>
                                </li>
                                <form action="{{ route('boards.delete', $board->id) }}" method="POST" class="c-itemMenu__item">
                                    @method('DELETE')
                                    @csrf
                                    <button class="c-itemMenu__txt" onclick='return confirm("削除しますか？");'><i class="fas fa-trash-alt c-itemMenu__icon"></i>削除</button>
                                </form>
                            </ul>
                        </div>
                    </div>
