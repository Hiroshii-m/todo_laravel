            ...
            @foreach($boards as $board)
                <li class="p-boardList__item">
                    ...
                    <div class="p-boardList__left">
                        ...
                        <ul class="p-boardList__opMenu js-target-display">
                            <li class="p-boardList__opItem">
                                <a href="{{ route('clusters', $board->id) }}" class="u-block u-padding--m-l">
                                    <i class="far fa-folder-open u-margin--0-m"></i>{{ __('Open') }}
                                </a>
                            </li>
