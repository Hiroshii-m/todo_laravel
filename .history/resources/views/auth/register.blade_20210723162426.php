...
<section id="l-main">
    <form class="c-form" method="POST" action="{{ route('register') }}">
        ...
        <label for="password" class="c-form__label">
            {{ __('Password') }}
            <input id="password" type="text" class="c-form__input" name="password" required autocomplete="new-password" autofocus>
            @error('password')
                <p class="c-form__error">{{ $message }}</p>
            @enderror
        </label>
        <label for="password_confirmation" class="c-form__label">
            {{ __('Confirm Password') }}
            <input id="password_confirmation" type="text" class="c-form__input" name="password_confirmation" value="{{ __('password_confirmation') }}" required autocomplete="new-password" autofocus>
            @error('password_confirmation')
                <p class="c-form__error">{{ $message }}</p>
            @enderror
        </label>
        <button class="c-form__submit u-bgColor--success">{{ __('Register') }}</button>
    </form>
</section>
@endsection
