...
<section id="l-main">
    <form class="c-form" method="POST">
        ...
        <label for="password_confirmation" class="c-form__label">
            パスワード（再入力）
            <input id="password_confirmation" type="text" class="c-form__input" name="password_confirmation" value="{{ __('password_confirmation') }}" required autocomplete="password_confirmation" autofocus>
